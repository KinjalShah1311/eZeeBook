...
class DataService {
  ...
  retrieveImages(hotelId) {
    ...
    const options = {
      method: 'GET',
      url: 'https://hotels-com-free.p.rapidapi.com/nice/image-catalog/v2/hotels/' + hotelId,
      headers: {
  ...
  retrieveReviews(hotelId) {
    const options = {
      method: 'GET',
      url: 'https://hotels-com-free.p.rapidapi.com/mobile_service/property-content/v1/hotels.com/property/' + hotelId + '/reviews',
